...
| M1 Walking Skeleton | ✅ Done (T1–T8) — T1–T7 code-complete, Gate G1 evidence: [docs/demo-m1.md](docs/demo-m1.md), E2E + AST containment tests in CI. T8 quality probe ran on 2026-08-26 with `gemma4:12b-mlx` (5/5 samples met acceptance criteria, adherence 5/5); findings: [docs/probes/m1-quality-probe.md](docs/probes/m1-quality-probe.md). T8 follow-ups integrated 2026-08-26: M1-T8.1 (synthesis preamble suppression), M1-T8.2 (default planning budget 120s→300s), M1-T8.3 (synthesizing-phase atomicity recovery test) |
| M2 Container Spine | 🚧 In progress — T1 done (rootless podman lifecycle spike, 7/7 checks pass on macOS, [ADR-0007](docs/adr/0007-podman-lifecycle.md)); T2–T6 unblocked |
